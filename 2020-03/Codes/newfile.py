...
# path="/home/aistudio/data/"+name+".tsv"
...
plt.savefig("./"+name+"/"+name+"StarAndReviewsInDetials.png")
...
plt.legend(loc="best",framealpha=0.3)
plt.savefig("./"+name+"/"+name+"StarAndReviewWithAverage.png")
...
plt.legend(loc="best",framealpha=0.3)
plt.savefig("./"+name+"/"+name+"StarAndUsefulnessInDetails.png")
...
# plt.legend()
plt.savefig("./"+name+"/"+name+"StarAndUsefulnessAverage.png")
...
for i in range(0,length):
    ...
    ShowScore[i]*=100
plt.scatter(rateAlpha,ShowScore,label="Reviews Score",s=1)
