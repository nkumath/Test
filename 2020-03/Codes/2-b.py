...
for i in range(0,count):
    ...
    # print(POSTIVEHELPFULNESS)
    # print(NEGATIVEHELPFULNESS)
    # print(postivehelpfulness)
    # print(negativehelpfulness)
    plt.cla()
    plt.clf()
    ...
    # MaxGroup=np.empty(everyExcelSize[i],1)
    # for mn in range(0,everyExcelSize[i]):
    #     for nm in range(0,9):
    #         everyExcelSize[mn,nm]=0
    # for i in range(0,everyExcelSize[i]):
    ...
    for mn in range(0,int(everyExcelSize[i])):
        ...
        # for nm in range(0,9):
        #     PicoutputExcel[mn,nm]=outputExcel[mn,nm]
    print(MaxNumber)
    for mn in range(0,int(everyExcelSize[i])):
    ...
    # plt.plot(x,outputExcel[:,3],label="Review Score")
    plt.plot(x,PicoutputExcel[:,2],label="Review Score")
    # plt.plot(x,outputExcel[:,4],label="Positive Helpfulness")
    plt.plot(x,PicoutputExcel[:,3],label="Helpfulness")
    # plt.plot(x,PicoutputExcel[:,3],label="Positive Helpfulness")
    # plt.plot(x,outputExcel[:,5],label="Negative Helpfulness")
    # plt.plot(x,PicoutputExcel[:,4],label="Negative Helpfulness")
    plt.legend(loc="best",framealpha=0.3)
    ...
    # plt.plot(x,outputExcel[:,8],label="Review Score")
    plt.plot(x,PicoutputExcel[:,6],label="Review Score")
    # plt.plot(x,outputExcel[:,9],label="Positive Helpfulness")
    plt.plot(x,PicoutputExcel[:,7],label="Helpfulness")
    # plt.plot(x,PicoutputExcel[:,7],label="Positive Helpfulness")
    # plt.plot(x,outputExcel[:,10],label="Negative Helpfulness")
    # plt.plot(x,PicoutputExcel[:,8],label="Negative Helpfulness")
    plt.legend(loc="best",framealpha=0.3)
    ...
    # plt.plot(x,PicoutputExcel[:,3],label="Positive Helpfulness")
    # plt.plot(x,PicoutputExcel[:,4],label="Negative Helpfulness")
    # plt.plot(x,outputExcel[:,1],label="Purchased")
    # plt.plot(x,outputExcel[:,7],label="Star Rating")
    # plt.plot(x,outputExcel[:,8],label="Review Score")
    # plt.plot(x,outputExcel[:,9],label="Positive Helpfulness")
    # plt.plot(x,outputExcel[:,10],label="Negative Helpfulness")
