...
for i in range(0,count):
    ...
    for z in x:
        ...
        PicoutputExcel[z,2]=outputExcel[z,7]/5
        PicoutputExcel[z,3]=outputExcel[z,8]/5
        PicoutputExcel[z,4]=outputExcel[z,9]/5
        PicoutputExcel[z,5]=outputExcel[z,10]/1.2
    ...
    plt.savefig("./"+name+"/2/"+name+"-Stage-TrendOf"+str(npdata[idList[i],3])+".png")
    plt.cla()
    plt.clf()
