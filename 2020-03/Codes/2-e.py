...
for i in range(0,length):
    ...
    # titleInfo=npdata[i,12]
    # contentInfo=npdata[i,13]
    # titleBlob=textblob.TextBlob(str(titleInfo))
    ...
    # contentBlob=textblob.TextBlob(str(contentInfo))
...
writer=pd.ExcelWriter("./"+name+"/For2E"+name+".xlsx")
